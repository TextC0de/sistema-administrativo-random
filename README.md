...
This template shows how you can use a MongoDB database to support your Next.js application.
It's been extended to have simple user registration and login, using cookies and json web tokens
...
- `NODE_ENV` should state whether you're in development or in production
- `SECRET` should be your key for encrypting jwt for authorization
