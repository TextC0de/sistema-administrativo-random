...
export default function EditProfileForm(): JSX.Element {
	...
	return (
		<>
			<form
				className="flex flex-col gap-4 bg-white rounded-xl border border-gray-150 p-4 mx-auto w-1/2 my-4"
			...
			>
				...
				<div>
					<div className="mb-2 block">
						<Label htmlFor="currentPassword" value="Contraseña actual" className="text-lg" />
					</div>
					<TextInput
						id="currentPassword"
					...
					/>
					<div className="mb-2 block">
						<Label htmlFor="name error" value={errors.currentPassword} className="text-lg" color="failure" />
					</div>
				</div>
				<div>
					<div className="mb-2 block">
						<Label htmlFor="newPassword" value="Nueva contraseña" className="text-lg" />
					</div>
					<TextInput
						id="newPassword"
						name="newPassword"
					...
					/>
					<div className="mb-2 block">
						<Label htmlFor="name error" value={errors.newPassword} className="text-lg" color="failure" />
					</div>
				</div>
				<div>
					<div className="mb-2 block">
						<Label htmlFor="confirmNewPassword" value="Confirmar nueva contraseña" className="text-lg" />
					</div>
					<TextInput
					...
					/>
					<div className="mb-2 block">
						<Label htmlFor="name error" value={errors.confirmNewPassword} className="text-lg" color="failure" />
					</div>
				</div>
