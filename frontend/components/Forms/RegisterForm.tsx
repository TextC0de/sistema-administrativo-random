	...
	return (
		<>
			<form className="flex flex-col gap-4" onSubmit={handleSubmit}>
				...
				<TextInput type="text" maxLength={20} name="lastName" value={form.lastName} onChange={handleChange} required />

				<label htmlFor="email">Email</label>
				<TextInput type="email" maxLength={40} name="email" value={form.email} onChange={handleChange} required />
