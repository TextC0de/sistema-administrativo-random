			...
			<form className="flex flex-col gap-4 w-1/2 p-4 rounded-3xl mx-auto my-4 bg-gray-50" onSubmit={handleSubmit}>
				...
				<div>
					<div className="mb-2 block">
						<Label htmlFor="name" value="Nombre de la ciudad" className="text-lg" />
					</div>
					<TextInput
						id="name"
						type="text"
				...
				<div id="select-province">
					<div className="mb-2 block">
						<Label htmlFor="province" value="Elegi la provincia" className="text-lg" />
					</div>
					<Select
						id="provinces"
						required={true}
					...
					<div className="mb-2 block">
						<Label htmlFor="province error" value={errors.province} className="text-lg" color="failure" />
					</div>
				</div>
