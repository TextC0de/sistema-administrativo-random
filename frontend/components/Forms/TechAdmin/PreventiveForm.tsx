...
import { type IBranch, type IBusiness, ICity, type IClient, IPreventive, type IUser } from 'backend/models/interfaces'
            ...
            <div id='task' className='flex flex-col my-4 mx-auto w-1/2 bg-gray-50 rounded-3xl p-4'>
                ...
                <div id='select-branch'>
                    ...
                    >
                        ...
                        {(filteredBranches != null) && filteredBranches.map((branch, index) => <option key={index}>{`${branch.number}, ${branch.city.name}`}</option>)}
                    </Select>
                    <div className='mb-2 block'>
                        <Label
                        htmlFor='branch'
