...
return(
    <>
        <div className='flex justify-between items-center px-5 py-4 border-bottom border-1 bg-white border-gray-400'>
            ...
            <Link href={path}>
                <button className='flex gap-2 py-2 pl-2 pr-3 justify-between text-sm items-center bg-gray-900 text-white  hover:bg-gray-700 border border-1 border-gray-300 rounded-lg select-none'>
                    <BsPlus size='20' />
                    <h4>
                        {nameButton}
                    </h4>
