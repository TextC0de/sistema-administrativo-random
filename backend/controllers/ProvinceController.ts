...
const ProvinceController = {
    putProvince: async(req: NextConnectApiRequest, res: NextApiResponse<ResponseData>) => {
        ...
        if (newProvince == null) return res.json({ statusCode: 500, error: 'could not update province' })
    ...
    deleteProvince: async(req: NextConnectApiRequest, res: NextApiResponse<ResponseData>) => {
        ...
        if (deletedProvince == null) return res.json({ statusCode: 500, error: 'could not delete province' })
